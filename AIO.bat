...
:: Created by Bram
:: https://github.com/BramSuurdje/AIO-Optimizer-Windows
:: https://www.paypal.com/paypalme/BramSuurdje

set version=AIO Optimizer 1.0
title %version%
...
echo $chck52 = New-Object Windows.Forms.Checkbox; github.com/BramSuurdje
...
echo $tooltip55.SetToolTip^($chck55, 'More details on github.com/BramSuurdje '^)
echo }^)
...
echo $tooltip56.SetToolTip^($chck56, 'More details on github.com/BramSuurdje '^)
echo }^)
...
echo $aboutFormText2.Text = '      GitHub.com/BramSuurdje'; 
...
echo [scriptblock]$donate= {start https://www.paypal.com/paypalme/BramSuurdje}; 
...
echo. 
echo %b%                  ╔═════════════════════════════════════════╗
echo %b%                  ║ [%wh%-%b%] %wh%Version: %b%%version:~13%                       %b%║
echo %b%                  ║ [%wh%-%b%] %wh%Build: %b%Public                       %b%║
echo %b%                  ║ [%wh%-%b%] %wh%Created by: %b%Bram                    %b%║
echo %b%                  ║ [%wh%-%b%] %wh%Last update: %b%17.04.2023             %b%║
echo %b%                  ╚═════════════════════════════════════════╝%wh%
echo.
